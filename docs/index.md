...
<img align="left" src="img/samples_bar.png"> 1. [Sample attributes view](http://www.vizome.org/aml/)
This view provides several methods to define a global filter that will limit browsing in Vizome to a subset of samples.
<br clear="left"/>

![samples_bar](img/samples_bar.png?classes = float-left) 

### 1. [Sample attributes view](http://www.vizome.org/aml/)
This view provides several methods to define a global filter that will limit browsing in Vizome to a subset of samples.
<br clear="left"/>

![samples_bar](img/samples_bar.png?classes = float-left) 1. [Sample attributes view](http://www.vizome.org/aml/)
This view provides several methods to define a global filter that will limit browsing in Vizome to a subset of samples.
<br clear="left"/>
